...
def make_character_selection_screen(venster):
    ...
    template_character1_button = Label(venster, text="Hobbit", image=template_character1_image, compound="bottom", bg="#603000", fg="white")
    ...
    template_character2_button = Label(venster, text="Elf", image=template_character2_image, compound="bottom", bg="#603000", fg="white")
    ...
    template_character3_button = Label(venster, text="Dwarf", image=template_character3_image, compound="bottom", bg="#603000", fg="white")
