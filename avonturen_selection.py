...
def make_adventure_selection_screen(venster):
    ...
    adventure1_button.bind("<Button-1>", lambda click_event: generate_screen(venster))
    ...
    adventure2_button.bind("<Button-1>", lambda click_event: generate_screen(venster))
    ...
    adventure3_button.bind("<Button-1>", lambda click_event: generate_screen(venster))
